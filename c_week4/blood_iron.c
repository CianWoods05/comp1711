    ...
    while (1)
    {
        ...
        case 'a':
            ...
            while (fgets(line, buffer_size, input))
            {
                ...
                //tokeniseDate(daily_readings[counter].date, "-", daily_readings[counter].day , daily_readings[counter].month , daily_readings[counter].year);
                counter++;
            }
        ...
        case 'd':
            ...
            printf("Your highest blood iron was %d\n", highest);
            fclose(input);
            return 0;
            break;
